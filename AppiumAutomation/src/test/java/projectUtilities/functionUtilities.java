...
public class functionUtilities {
	...
	public void scrollUpToUserCount(AppiumDriver testDriver, WebElement area, int count) {
	...
	public void scrollUp(AppiumDriver testDriver, WebElement area) {
	...
	public void scrollDown(AppiumDriver testDriver, WebElement area) {
		testDriver.executeScript("mobile: scrollGesture",
				ImmutableMap.of("elementId", ((RemoteWebElement) area).getId(), "direction", "down", "percent", 1.0));
	}
	
	public void scrollLeft(AppiumDriver testDriver, WebElement area) {
		testDriver.executeScript("mobile: scrollGesture",
				ImmutableMap.of("elementId", ((RemoteWebElement) area).getId(), "direction", "left", "percent", 1.0));
	}
	
	public void scrollRight(AppiumDriver testDriver, WebElement area) {
		testDriver.executeScript("mobile: scrollGesture",
